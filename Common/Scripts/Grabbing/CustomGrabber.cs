...
public class CustomGrabber : OVRGrabber
{
    ...
    public static OVRGrabber leftHandGrabber;
    public static OVRGrabber rightHandGrabber;
    public static OVRGrabbable objectInLeftHand;
    public static OVRGrabbable objectInRightHand;
    ...
    /// <summary>
    /// Store the left and right hand grabbers for easy access.
    /// </summary>
    protected override void Start()
    {
        ...
        {
            leftHandGrabber = this;
        }
        else
        {
            rightHandGrabber = this;
        }
    }

    /// <summary>
    /// Check for the closest grabbable object every frame.
    /// </summary>
    ...
    /// <summary>
    /// Return the closest grabbable object for this grabber.
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Return the closest distance grabbable object.
    /// </summary>
    ...
    protected override void GrabBegin()
    {
        ...
        if (closestGrabbable != null)
        {
            ...
            {
                objectInRightHand = closestGrabbable;
            }
